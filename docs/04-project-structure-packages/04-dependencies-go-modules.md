...
Это лишь обзор. Когда воркспейс действительно нужен, как им пользоваться, коммитить ли его и какие у него плюсы и минусы — в следующей главе [Воркспейсы (`go.work`)](./05-workspaces.md).
...
[⌂ Главная](../../README.md) · [↑ Раздел](./README.md) · [← Предыдущий: Пакеты и видимость](./03-packages-and-visibility.md) · [→ Следующий: Воркспейсы (go.work)](./05-workspaces.md)
